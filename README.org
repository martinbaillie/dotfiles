...
The [[Makefile][Makefile]] (in conjunction with some helpful [[default.nix#58][aliases]]) is used to drive most actions, abstracting away NixOS/macOS differences where necessary.
