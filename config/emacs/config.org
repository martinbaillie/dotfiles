...
(use-package! edit-server
  :config
  (edit-server-start)
  (setq edit-server-default-major-mode 'indented-text-mode
        edit-server-url-major-mode-alist '(("github\\.com" . markdown-mode))
        edit-server-htmlize-url-regexp (mapconcat
                                        (lambda(s) (concat "^" (regexp-quote s)))
                                        '( "app.slack.com"
                                           "mail.google.com/mail/") "\\|"))
  (autoload 'edit-server-maybe-dehtmlize-buffer "edit-server-htmlize"
    "edit-server-htmlize" t)
