...
(after! doom-modeline
  ...
  ;; Word counts in Markdown, Org etc.
...
(after! org-gcal
  (setq mb/calendar-dir (file-truename (concat org-directory "/" "cal"))
        org-gcal-client-id (auth-source-pick-first-password
                            :host "calendar.google.com" :user "martin@baillie.id^client")
        org-gcal-client-secret (auth-source-pick-first-password
                            :host "calendar.google.com" :user "martin@baillie.id^password")
        org-gcal-token-file "/etc/dotfiles/.private/org-gcal.gpg"
        org-gcal-fetch-file-alist `(("martin@baillie.id" . ,(concat
                                                            mb/calendar-dir
                                                            "/"
                                                            "martin@baillie.id.org"))))
...
Org mode mixed pitch and solaire mode looks more aesthetically pleasing.
TODO: Mixed pitch font.
#+begin_src elisp
